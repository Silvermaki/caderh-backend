...
export const sgc_cursos = sequelize.define('cursos', {
    ...
    total_horas: { type: DataTypes.TEXT, allowNull: true, defaultValue: '0' },
...
export const sgc_instructors = sequelize.define('instructors', {
    ...
    centro_id: { type: DataTypes.INTEGER, allowNull: false },
    identidad: { type: DataTypes.TEXT, allowNull: true },
    ...
    nivel_escolaridad_id: { type: DataTypes.INTEGER, allowNull: true, defaultValue: null },
